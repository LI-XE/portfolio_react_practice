            ...
            <Box component="div" className={classes.timeLine}>
              ...
              <Box component="div" className={classes.timeLineItem}>
                  ...
                  <Typography variant="subtitle1" align="center" style={{color: "tan"}}>
                      Web designddddddAASDSAFASFASFlofsfdsafdfasfadsfdsfsf
                  </Typography>
              </Box>
              ...
              <Box component="div" className={classes.timeLineItem}>
                  ...
                  <Typography variant="body1" align="center" style={{color: "tomato", padding:"1rem"}}>
                      company name where worked
                  </Typography>
                  <Typography variant="subtitle1" align="center" style={{color: "tan"}}>
                      Web designddddddAASDSAFASFASFlofsfdsafdfasfadsfdsfsf
              ...
              <Box component="div" className={classes.timeLineItem}>
                  ...
                  <Typography variant="subtitle1" align="center" style={{color: "tan"}}>
                      Web designddddddAASDSAFASFASFlofsfdsafdfasfadsfdsfsfWeb designddddddAASDSAFASFASFlofsfdsafdfasfadsfdsfsfWeb designddddddAASDSAFASFASFlofsfdsafdfasfadsfdsfsf
                  </Typography>
              </Box>
